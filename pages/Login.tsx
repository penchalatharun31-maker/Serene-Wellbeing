...
const Login: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 ${showCompanyBranding ? 'lg:bg-white' : ''}`}>
      ...
      <div className={`w-full space-y-8 flex-1 flex items-center justify-center ${showCompanyBranding ? 'max-w-5xl mx-auto flex flex-col lg:flex-row gap-16 items-center' : 'max-w-md mx-auto'}`}>
