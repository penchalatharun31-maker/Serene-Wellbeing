...
const GroupSessions: React.FC = () => {
    ...
    const handleBookClick = () => {
        if (!isAuthenticated) {
            ...
            // Logic for authenticated booking would go here
            alert("Authenticated! Opening group booking logic...");
        }
    };
    return (
                        ...
                        <Card key={session.id} className="flex flex-col h-full hover:border-emerald-300 transition-colors">
                            ...
                            <div className="p-5 flex-1 flex flex-col">
                                ...
                                <div className="mt-auto">
                                    <Button className="w-full" onClick={handleBookClick}>Book Seat</Button>
                                </div>
                            </div>
                        </Card>
                    ))}
