...
export const NAVIGATION_LINKS = {
  user: [
    ...
    { name: 'Find Match', icon: Sparkles, path: '/dashboard/user/find-match' },
    { name: 'AI Companion', icon: MessageCircle, path: '/dashboard/user/ai-companion' },
    { name: 'Mood Tracker', icon: BarChart2, path: '/dashboard/user/mood-tracker' },
    { name: 'Journal', icon: Edit, path: '/dashboard/user/journal' },
    { name: 'Challenges', icon: BarChart2, path: '/dashboard/user/challenges' },
    { name: 'Content Library', icon: BookOpen, path: '/dashboard/user/content-library' },
    { name: 'Sessions', icon: Calendar, path: '/dashboard/user/sessions' },
    { name: 'Experts', icon: Users, path: '/browse' },
    { name: 'Messages', icon: MessageCircle, path: '/dashboard/user/messages' },
